...
import os
import time
from Infrastructure.Session.BaseSession import BaseSession
...
class CacheSession(BaseSession):
    ...
    def initialize(self, handler, expires):
        ...
        handler.set_cookie(CacheSession.session_id,
    ...
    def __setitem__(self, key, value):
        # print(CacheSession.create_session_id())
